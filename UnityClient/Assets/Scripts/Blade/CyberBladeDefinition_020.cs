namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #020
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_020", menuName = "SliceStorm/Blade #020")]
    public class CyberBladeDefinition_020 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_020";
        [SerializeField] private string bladeName = "Plasma Katana #020";
        ...
        {
            return swipeSpeed * 1.5f + (20 * 0.05f);
        }
    }
}
