namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #080
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_080", menuName = "SliceStorm/Blade #080")]
    public class CyberBladeDefinition_080 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_080";
        [SerializeField] private string bladeName = "Plasma Katana #080";
        ...
        {
            return swipeSpeed * 1.5f + (80 * 0.05f);
        }
    }
}
