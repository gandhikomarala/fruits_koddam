namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #074
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_074", menuName = "SliceStorm/Blade #074")]
    public class CyberBladeDefinition_074 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_074";
        [SerializeField] private string bladeName = "Plasma Katana #074";
        ...
        {
            return swipeSpeed * 1.5f + (74 * 0.05f);
        }
    }
}
