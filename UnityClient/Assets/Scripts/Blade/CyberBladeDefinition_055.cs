namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #055
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_055", menuName = "SliceStorm/Blade #055")]
    public class CyberBladeDefinition_055 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_055";
        [SerializeField] private string bladeName = "Plasma Katana #055";
        ...
        {
            return swipeSpeed * 1.5f + (55 * 0.05f);
        }
    }
}
