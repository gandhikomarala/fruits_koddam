namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #002
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_002", menuName = "SliceStorm/Blade #002")]
    public class CyberBladeDefinition_002 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_002";
        [SerializeField] private string bladeName = "Plasma Katana #002";
        ...
        {
            return swipeSpeed * 1.5f + (2 * 0.05f);
        }
    }
}
