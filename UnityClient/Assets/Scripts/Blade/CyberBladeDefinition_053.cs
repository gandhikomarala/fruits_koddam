namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #053
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_053", menuName = "SliceStorm/Blade #053")]
    public class CyberBladeDefinition_053 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_053";
        [SerializeField] private string bladeName = "Plasma Katana #053";
        ...
        {
            return swipeSpeed * 1.5f + (53 * 0.05f);
        }
    }
}
