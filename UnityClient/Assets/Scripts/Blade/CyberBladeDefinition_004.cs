namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #004
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_004", menuName = "SliceStorm/Blade #004")]
    public class CyberBladeDefinition_004 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_004";
        [SerializeField] private string bladeName = "Plasma Katana #004";
        ...
        {
            return swipeSpeed * 1.5f + (4 * 0.05f);
        }
    }
}
