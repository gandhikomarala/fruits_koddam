namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #046
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_046", menuName = "SliceStorm/Blade #046")]
    public class CyberBladeDefinition_046 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_046";
        [SerializeField] private string bladeName = "Plasma Katana #046";
        ...
        {
            return swipeSpeed * 1.5f + (46 * 0.05f);
        }
    }
}
