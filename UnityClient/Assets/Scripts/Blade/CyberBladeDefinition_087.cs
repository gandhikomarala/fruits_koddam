namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #087
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_087", menuName = "SliceStorm/Blade #087")]
    public class CyberBladeDefinition_087 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_087";
        [SerializeField] private string bladeName = "Plasma Katana #087";
        ...
        {
            return swipeSpeed * 1.5f + (87 * 0.05f);
        }
    }
}
