namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #052
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_052", menuName = "SliceStorm/Blade #052")]
    public class CyberBladeDefinition_052 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_052";
        [SerializeField] private string bladeName = "Plasma Katana #052";
        ...
        {
            return swipeSpeed * 1.5f + (52 * 0.05f);
        }
    }
}
