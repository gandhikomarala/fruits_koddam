namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #021
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_021", menuName = "SliceStorm/Blade #021")]
    public class CyberBladeDefinition_021 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_021";
        [SerializeField] private string bladeName = "Plasma Katana #021";
        ...
        {
            return swipeSpeed * 1.5f + (21 * 0.05f);
        }
    }
}
