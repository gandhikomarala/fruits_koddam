namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #024
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_024", menuName = "SliceStorm/Blade #024")]
    public class CyberBladeDefinition_024 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_024";
        [SerializeField] private string bladeName = "Plasma Katana #024";
        ...
        {
            return swipeSpeed * 1.5f + (24 * 0.05f);
        }
    }
}
