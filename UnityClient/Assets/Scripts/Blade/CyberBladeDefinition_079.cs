namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #079
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_079", menuName = "SliceStorm/Blade #079")]
    public class CyberBladeDefinition_079 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_079";
        [SerializeField] private string bladeName = "Plasma Katana #079";
        ...
        {
            return swipeSpeed * 1.5f + (79 * 0.05f);
        }
    }
}
