namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #090
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_090", menuName = "SliceStorm/Blade #090")]
    public class CyberBladeDefinition_090 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_090";
        [SerializeField] private string bladeName = "Plasma Katana #090";
        ...
        {
            return swipeSpeed * 1.5f + (90 * 0.05f);
        }
    }
}
