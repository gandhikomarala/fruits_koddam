namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #049
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_049", menuName = "SliceStorm/Blade #049")]
    public class CyberBladeDefinition_049 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_049";
        [SerializeField] private string bladeName = "Plasma Katana #049";
        ...
        {
            return swipeSpeed * 1.5f + (49 * 0.05f);
        }
    }
}
