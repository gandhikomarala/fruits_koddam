namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #076
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_076", menuName = "SliceStorm/Blade #076")]
    public class CyberBladeDefinition_076 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_076";
        [SerializeField] private string bladeName = "Plasma Katana #076";
        ...
        {
            return swipeSpeed * 1.5f + (76 * 0.05f);
        }
    }
}
