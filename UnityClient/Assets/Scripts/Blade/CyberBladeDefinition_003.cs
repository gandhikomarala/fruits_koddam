namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #003
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_003", menuName = "SliceStorm/Blade #003")]
    public class CyberBladeDefinition_003 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_003";
        [SerializeField] private string bladeName = "Plasma Katana #003";
        ...
        {
            return swipeSpeed * 1.5f + (3 * 0.05f);
        }
    }
}
