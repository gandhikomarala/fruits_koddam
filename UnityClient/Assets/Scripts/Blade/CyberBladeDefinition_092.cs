namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #092
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_092", menuName = "SliceStorm/Blade #092")]
    public class CyberBladeDefinition_092 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_092";
        [SerializeField] private string bladeName = "Plasma Katana #092";
        ...
        {
            return swipeSpeed * 1.5f + (92 * 0.05f);
        }
    }
}
