namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #039
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_039", menuName = "SliceStorm/Blade #039")]
    public class CyberBladeDefinition_039 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_039";
        [SerializeField] private string bladeName = "Plasma Katana #039";
        ...
        {
            return swipeSpeed * 1.5f + (39 * 0.05f);
        }
    }
}
