namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #001
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_001", menuName = "SliceStorm/Blade #001")]
    public class CyberBladeDefinition_001 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_001";
        [SerializeField] private string bladeName = "Plasma Katana #001";
        ...
        {
            return swipeSpeed * 1.5f + (1 * 0.05f);
        }
    }
}
