namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #028
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_028", menuName = "SliceStorm/Blade #028")]
    public class CyberBladeDefinition_028 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_028";
        [SerializeField] private string bladeName = "Plasma Katana #028";
        ...
        {
            return swipeSpeed * 1.5f + (28 * 0.05f);
        }
    }
}
