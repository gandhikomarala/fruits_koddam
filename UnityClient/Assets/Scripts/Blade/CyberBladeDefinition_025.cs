namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #025
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_025", menuName = "SliceStorm/Blade #025")]
    public class CyberBladeDefinition_025 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_025";
        [SerializeField] private string bladeName = "Plasma Katana #025";
        ...
        {
            return swipeSpeed * 1.5f + (25 * 0.05f);
        }
    }
}
