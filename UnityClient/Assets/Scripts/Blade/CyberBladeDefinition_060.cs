namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #060
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_060", menuName = "SliceStorm/Blade #060")]
    public class CyberBladeDefinition_060 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_060";
        [SerializeField] private string bladeName = "Plasma Katana #060";
        ...
        {
            return swipeSpeed * 1.5f + (60 * 0.05f);
        }
    }
}
