namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #070
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_070", menuName = "SliceStorm/Blade #070")]
    public class CyberBladeDefinition_070 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_070";
        [SerializeField] private string bladeName = "Plasma Katana #070";
        ...
        {
            return swipeSpeed * 1.5f + (70 * 0.05f);
        }
    }
}
