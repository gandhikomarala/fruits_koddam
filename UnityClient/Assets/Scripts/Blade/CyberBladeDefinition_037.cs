namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #037
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_037", menuName = "SliceStorm/Blade #037")]
    public class CyberBladeDefinition_037 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_037";
        [SerializeField] private string bladeName = "Plasma Katana #037";
        ...
        {
            return swipeSpeed * 1.5f + (37 * 0.05f);
        }
    }
}
