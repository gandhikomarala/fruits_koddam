namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #064
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_064", menuName = "SliceStorm/Blade #064")]
    public class CyberBladeDefinition_064 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_064";
        [SerializeField] private string bladeName = "Plasma Katana #064";
        ...
        {
            return swipeSpeed * 1.5f + (64 * 0.05f);
        }
    }
}
