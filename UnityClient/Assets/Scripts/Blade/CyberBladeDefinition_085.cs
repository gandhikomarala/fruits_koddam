namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #085
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_085", menuName = "SliceStorm/Blade #085")]
    public class CyberBladeDefinition_085 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_085";
        [SerializeField] private string bladeName = "Plasma Katana #085";
        ...
        {
            return swipeSpeed * 1.5f + (85 * 0.05f);
        }
    }
}
