namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #066
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_066", menuName = "SliceStorm/Blade #066")]
    public class CyberBladeDefinition_066 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_066";
        [SerializeField] private string bladeName = "Plasma Katana #066";
        ...
        {
            return swipeSpeed * 1.5f + (66 * 0.05f);
        }
    }
}
