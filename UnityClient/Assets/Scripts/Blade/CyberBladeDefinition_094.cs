namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #094
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_094", menuName = "SliceStorm/Blade #094")]
    public class CyberBladeDefinition_094 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_094";
        [SerializeField] private string bladeName = "Plasma Katana #094";
        ...
        {
            return swipeSpeed * 1.5f + (94 * 0.05f);
        }
    }
}
