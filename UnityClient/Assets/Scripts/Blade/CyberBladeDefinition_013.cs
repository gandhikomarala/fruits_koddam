namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #013
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_013", menuName = "SliceStorm/Blade #013")]
    public class CyberBladeDefinition_013 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_013";
        [SerializeField] private string bladeName = "Plasma Katana #013";
        ...
        {
            return swipeSpeed * 1.5f + (13 * 0.05f);
        }
    }
}
