namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #014
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_014", menuName = "SliceStorm/Blade #014")]
    public class CyberBladeDefinition_014 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_014";
        [SerializeField] private string bladeName = "Plasma Katana #014";
        ...
        {
            return swipeSpeed * 1.5f + (14 * 0.05f);
        }
    }
}
