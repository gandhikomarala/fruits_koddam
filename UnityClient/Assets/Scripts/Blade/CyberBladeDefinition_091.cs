namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #091
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_091", menuName = "SliceStorm/Blade #091")]
    public class CyberBladeDefinition_091 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_091";
        [SerializeField] private string bladeName = "Plasma Katana #091";
        ...
        {
            return swipeSpeed * 1.5f + (91 * 0.05f);
        }
    }
}
