namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #016
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_016", menuName = "SliceStorm/Blade #016")]
    public class CyberBladeDefinition_016 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_016";
        [SerializeField] private string bladeName = "Plasma Katana #016";
        ...
        {
            return swipeSpeed * 1.5f + (16 * 0.05f);
        }
    }
}
