namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #054
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_054", menuName = "SliceStorm/Blade #054")]
    public class CyberBladeDefinition_054 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_054";
        [SerializeField] private string bladeName = "Plasma Katana #054";
        ...
        {
            return swipeSpeed * 1.5f + (54 * 0.05f);
        }
    }
}
