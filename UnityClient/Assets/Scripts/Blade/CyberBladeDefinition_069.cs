namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #069
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_069", menuName = "SliceStorm/Blade #069")]
    public class CyberBladeDefinition_069 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_069";
        [SerializeField] private string bladeName = "Plasma Katana #069";
        ...
        {
            return swipeSpeed * 1.5f + (69 * 0.05f);
        }
    }
}
