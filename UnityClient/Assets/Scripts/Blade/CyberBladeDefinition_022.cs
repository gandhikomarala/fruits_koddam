namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #022
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_022", menuName = "SliceStorm/Blade #022")]
    public class CyberBladeDefinition_022 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_022";
        [SerializeField] private string bladeName = "Plasma Katana #022";
        ...
        {
            return swipeSpeed * 1.5f + (22 * 0.05f);
        }
    }
}
