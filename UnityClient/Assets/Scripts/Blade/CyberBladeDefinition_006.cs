namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #006
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_006", menuName = "SliceStorm/Blade #006")]
    public class CyberBladeDefinition_006 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_006";
        [SerializeField] private string bladeName = "Plasma Katana #006";
        ...
        {
            return swipeSpeed * 1.5f + (6 * 0.05f);
        }
    }
}
