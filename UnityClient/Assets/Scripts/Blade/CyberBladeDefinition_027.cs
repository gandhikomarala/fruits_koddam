namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #027
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_027", menuName = "SliceStorm/Blade #027")]
    public class CyberBladeDefinition_027 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_027";
        [SerializeField] private string bladeName = "Plasma Katana #027";
        ...
        {
            return swipeSpeed * 1.5f + (27 * 0.05f);
        }
    }
}
