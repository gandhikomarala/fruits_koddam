namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #096
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_096", menuName = "SliceStorm/Blade #096")]
    public class CyberBladeDefinition_096 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_096";
        [SerializeField] private string bladeName = "Plasma Katana #096";
        ...
        {
            return swipeSpeed * 1.5f + (96 * 0.05f);
        }
    }
}
