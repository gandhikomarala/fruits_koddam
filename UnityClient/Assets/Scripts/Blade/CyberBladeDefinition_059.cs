namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #059
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_059", menuName = "SliceStorm/Blade #059")]
    public class CyberBladeDefinition_059 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_059";
        [SerializeField] private string bladeName = "Plasma Katana #059";
        ...
        {
            return swipeSpeed * 1.5f + (59 * 0.05f);
        }
    }
}
