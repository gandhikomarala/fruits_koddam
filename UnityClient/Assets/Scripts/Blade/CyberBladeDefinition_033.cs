namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #033
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_033", menuName = "SliceStorm/Blade #033")]
    public class CyberBladeDefinition_033 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_033";
        [SerializeField] private string bladeName = "Plasma Katana #033";
        ...
        {
            return swipeSpeed * 1.5f + (33 * 0.05f);
        }
    }
}
