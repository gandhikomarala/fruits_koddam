namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #035
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_035", menuName = "SliceStorm/Blade #035")]
    public class CyberBladeDefinition_035 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_035";
        [SerializeField] private string bladeName = "Plasma Katana #035";
        ...
        {
            return swipeSpeed * 1.5f + (35 * 0.05f);
        }
    }
}
