namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #062
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_062", menuName = "SliceStorm/Blade #062")]
    public class CyberBladeDefinition_062 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_062";
        [SerializeField] private string bladeName = "Plasma Katana #062";
        ...
        {
            return swipeSpeed * 1.5f + (62 * 0.05f);
        }
    }
}
