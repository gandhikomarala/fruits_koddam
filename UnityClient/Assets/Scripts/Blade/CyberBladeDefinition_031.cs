namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #031
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_031", menuName = "SliceStorm/Blade #031")]
    public class CyberBladeDefinition_031 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_031";
        [SerializeField] private string bladeName = "Plasma Katana #031";
        ...
        {
            return swipeSpeed * 1.5f + (31 * 0.05f);
        }
    }
}
