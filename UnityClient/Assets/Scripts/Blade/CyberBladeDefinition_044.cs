namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #044
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_044", menuName = "SliceStorm/Blade #044")]
    public class CyberBladeDefinition_044 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_044";
        [SerializeField] private string bladeName = "Plasma Katana #044";
        ...
        {
            return swipeSpeed * 1.5f + (44 * 0.05f);
        }
    }
}
