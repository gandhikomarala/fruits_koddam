namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #093
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_093", menuName = "SliceStorm/Blade #093")]
    public class CyberBladeDefinition_093 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_093";
        [SerializeField] private string bladeName = "Plasma Katana #093";
        ...
        {
            return swipeSpeed * 1.5f + (93 * 0.05f);
        }
    }
}
