namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #099
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_099", menuName = "SliceStorm/Blade #099")]
    public class CyberBladeDefinition_099 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_099";
        [SerializeField] private string bladeName = "Plasma Katana #099";
        ...
        {
            return swipeSpeed * 1.5f + (99 * 0.05f);
        }
    }
}
