namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #026
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_026", menuName = "SliceStorm/Blade #026")]
    public class CyberBladeDefinition_026 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_026";
        [SerializeField] private string bladeName = "Plasma Katana #026";
        ...
        {
            return swipeSpeed * 1.5f + (26 * 0.05f);
        }
    }
}
