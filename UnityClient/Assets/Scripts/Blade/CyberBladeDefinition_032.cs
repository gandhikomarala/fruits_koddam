namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #032
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_032", menuName = "SliceStorm/Blade #032")]
    public class CyberBladeDefinition_032 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_032";
        [SerializeField] private string bladeName = "Plasma Katana #032";
        ...
        {
            return swipeSpeed * 1.5f + (32 * 0.05f);
        }
    }
}
