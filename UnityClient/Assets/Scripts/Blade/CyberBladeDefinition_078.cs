namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #078
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_078", menuName = "SliceStorm/Blade #078")]
    public class CyberBladeDefinition_078 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_078";
        [SerializeField] private string bladeName = "Plasma Katana #078";
        ...
        {
            return swipeSpeed * 1.5f + (78 * 0.05f);
        }
    }
}
