namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #088
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_088", menuName = "SliceStorm/Blade #088")]
    public class CyberBladeDefinition_088 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_088";
        [SerializeField] private string bladeName = "Plasma Katana #088";
        ...
        {
            return swipeSpeed * 1.5f + (88 * 0.05f);
        }
    }
}
