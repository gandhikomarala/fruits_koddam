namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #015
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_015", menuName = "SliceStorm/Blade #015")]
    public class CyberBladeDefinition_015 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_015";
        [SerializeField] private string bladeName = "Plasma Katana #015";
        ...
        {
            return swipeSpeed * 1.5f + (15 * 0.05f);
        }
    }
}
