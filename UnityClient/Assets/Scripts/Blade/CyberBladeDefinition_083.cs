namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #083
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_083", menuName = "SliceStorm/Blade #083")]
    public class CyberBladeDefinition_083 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_083";
        [SerializeField] private string bladeName = "Plasma Katana #083";
        ...
        {
            return swipeSpeed * 1.5f + (83 * 0.05f);
        }
    }
}
