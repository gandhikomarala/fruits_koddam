namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #051
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_051", menuName = "SliceStorm/Blade #051")]
    public class CyberBladeDefinition_051 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_051";
        [SerializeField] private string bladeName = "Plasma Katana #051";
        ...
        {
            return swipeSpeed * 1.5f + (51 * 0.05f);
        }
    }
}
