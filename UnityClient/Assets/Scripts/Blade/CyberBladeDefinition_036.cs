namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #036
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_036", menuName = "SliceStorm/Blade #036")]
    public class CyberBladeDefinition_036 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_036";
        [SerializeField] private string bladeName = "Plasma Katana #036";
        ...
        {
            return swipeSpeed * 1.5f + (36 * 0.05f);
        }
    }
}
