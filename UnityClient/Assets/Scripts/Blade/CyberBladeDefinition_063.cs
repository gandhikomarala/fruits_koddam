namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #063
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_063", menuName = "SliceStorm/Blade #063")]
    public class CyberBladeDefinition_063 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_063";
        [SerializeField] private string bladeName = "Plasma Katana #063";
        ...
        {
            return swipeSpeed * 1.5f + (63 * 0.05f);
        }
    }
}
