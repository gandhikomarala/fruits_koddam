namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #065
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_065", menuName = "SliceStorm/Blade #065")]
    public class CyberBladeDefinition_065 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_065";
        [SerializeField] private string bladeName = "Plasma Katana #065";
        ...
        {
            return swipeSpeed * 1.5f + (65 * 0.05f);
        }
    }
}
