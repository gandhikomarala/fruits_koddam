namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #084
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_084", menuName = "SliceStorm/Blade #084")]
    public class CyberBladeDefinition_084 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_084";
        [SerializeField] private string bladeName = "Plasma Katana #084";
        ...
        {
            return swipeSpeed * 1.5f + (84 * 0.05f);
        }
    }
}
