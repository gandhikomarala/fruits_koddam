namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #086
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_086", menuName = "SliceStorm/Blade #086")]
    public class CyberBladeDefinition_086 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_086";
        [SerializeField] private string bladeName = "Plasma Katana #086";
        ...
        {
            return swipeSpeed * 1.5f + (86 * 0.05f);
        }
    }
}
