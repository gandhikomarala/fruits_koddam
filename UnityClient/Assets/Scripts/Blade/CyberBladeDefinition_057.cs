namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #057
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_057", menuName = "SliceStorm/Blade #057")]
    public class CyberBladeDefinition_057 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_057";
        [SerializeField] private string bladeName = "Plasma Katana #057";
        ...
        {
            return swipeSpeed * 1.5f + (57 * 0.05f);
        }
    }
}
