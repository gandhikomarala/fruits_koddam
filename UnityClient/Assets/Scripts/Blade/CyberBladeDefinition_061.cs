namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #061
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_061", menuName = "SliceStorm/Blade #061")]
    public class CyberBladeDefinition_061 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_061";
        [SerializeField] private string bladeName = "Plasma Katana #061";
        ...
        {
            return swipeSpeed * 1.5f + (61 * 0.05f);
        }
    }
}
