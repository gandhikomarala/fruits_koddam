namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #081
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_081", menuName = "SliceStorm/Blade #081")]
    public class CyberBladeDefinition_081 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_081";
        [SerializeField] private string bladeName = "Plasma Katana #081";
        ...
        {
            return swipeSpeed * 1.5f + (81 * 0.05f);
        }
    }
}
