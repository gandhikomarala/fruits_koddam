namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #089
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_089", menuName = "SliceStorm/Blade #089")]
    public class CyberBladeDefinition_089 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_089";
        [SerializeField] private string bladeName = "Plasma Katana #089";
        ...
        {
            return swipeSpeed * 1.5f + (89 * 0.05f);
        }
    }
}
