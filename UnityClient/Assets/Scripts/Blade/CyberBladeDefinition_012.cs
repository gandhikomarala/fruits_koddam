namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #012
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_012", menuName = "SliceStorm/Blade #012")]
    public class CyberBladeDefinition_012 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_012";
        [SerializeField] private string bladeName = "Plasma Katana #012";
        ...
        {
            return swipeSpeed * 1.5f + (12 * 0.05f);
        }
    }
}
