namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #097
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_097", menuName = "SliceStorm/Blade #097")]
    public class CyberBladeDefinition_097 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_097";
        [SerializeField] private string bladeName = "Plasma Katana #097";
        ...
        {
            return swipeSpeed * 1.5f + (97 * 0.05f);
        }
    }
}
