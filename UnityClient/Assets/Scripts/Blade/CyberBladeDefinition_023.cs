namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #023
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_023", menuName = "SliceStorm/Blade #023")]
    public class CyberBladeDefinition_023 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_023";
        [SerializeField] private string bladeName = "Plasma Katana #023";
        ...
        {
            return swipeSpeed * 1.5f + (23 * 0.05f);
        }
    }
}
