namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #100
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_100", menuName = "SliceStorm/Blade #100")]
    public class CyberBladeDefinition_100 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_100";
        [SerializeField] private string bladeName = "Plasma Katana #100";
        ...
        {
            return swipeSpeed * 1.5f + (100 * 0.05f);
        }
    }
}
