namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #009
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_009", menuName = "SliceStorm/Blade #009")]
    public class CyberBladeDefinition_009 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_009";
        [SerializeField] private string bladeName = "Plasma Katana #009";
        ...
        {
            return swipeSpeed * 1.5f + (9 * 0.05f);
        }
    }
}
