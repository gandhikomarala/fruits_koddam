namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #043
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_043", menuName = "SliceStorm/Blade #043")]
    public class CyberBladeDefinition_043 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_043";
        [SerializeField] private string bladeName = "Plasma Katana #043";
        ...
        {
            return swipeSpeed * 1.5f + (43 * 0.05f);
        }
    }
}
