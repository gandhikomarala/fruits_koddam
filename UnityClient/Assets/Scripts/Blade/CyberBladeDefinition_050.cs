namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #050
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_050", menuName = "SliceStorm/Blade #050")]
    public class CyberBladeDefinition_050 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_050";
        [SerializeField] private string bladeName = "Plasma Katana #050";
        ...
        {
            return swipeSpeed * 1.5f + (50 * 0.05f);
        }
    }
}
