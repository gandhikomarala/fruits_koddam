namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #042
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_042", menuName = "SliceStorm/Blade #042")]
    public class CyberBladeDefinition_042 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_042";
        [SerializeField] private string bladeName = "Plasma Katana #042";
        ...
        {
            return swipeSpeed * 1.5f + (42 * 0.05f);
        }
    }
}
