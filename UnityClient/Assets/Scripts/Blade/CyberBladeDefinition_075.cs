namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #075
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_075", menuName = "SliceStorm/Blade #075")]
    public class CyberBladeDefinition_075 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_075";
        [SerializeField] private string bladeName = "Plasma Katana #075";
        ...
        {
            return swipeSpeed * 1.5f + (75 * 0.05f);
        }
    }
}
