namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #067
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_067", menuName = "SliceStorm/Blade #067")]
    public class CyberBladeDefinition_067 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_067";
        [SerializeField] private string bladeName = "Plasma Katana #067";
        ...
        {
            return swipeSpeed * 1.5f + (67 * 0.05f);
        }
    }
}
