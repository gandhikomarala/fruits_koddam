namespace SliceStorm.Blade
{
    ...
    /// <summary>
    /// Cyber Blade & Particle Trail Definition #071
    /// Controls blade sharpness, trail neon shaders, and combo bonus multipliers.
    /// </summary>
    [CreateAssetMenu(fileName = "CyberBladeDefinition_071", menuName = "SliceStorm/Blade #071")]
    public class CyberBladeDefinition_071 : ScriptableObject
    {
        public enum BladeRarity { Standard, Rare, Epic, Legendary }

        [Header("Blade Attributes")]
        [SerializeField] private string bladeId = "BLADE_071";
        [SerializeField] private string bladeName = "Plasma Katana #071";
        ...
        {
            return swipeSpeed * 1.5f + (71 * 0.05f);
        }
    }
}
