namespace SliceStorm.Sliceables
{
    ...
    public class SliceableFruitUnit_036 : MonoBehaviour
    {
        ...
        [SerializeField] private int baseScore = 10 + (36 % 5) * 5;
        [SerializeField] private Color juiceParticleColor = new Color(0.95f, 0.2f, 0.4f, 1.0f);
        [SerializeField] private float launchVelocityY = 12.0f + (36 * 0.04f);
